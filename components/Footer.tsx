      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
          ...
          <div className="space-y-8">
            ...
            <p className="text-stone-500 leading-relaxed text-sm font-sans">
            ...
            <ul className="space-y-6 text-stone-600">
               <li className="group">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <a href="tel:+420774539020" className="hover:text-fresca-bronze transition-colors font-bold font-sans">+420 774 539 020</a>
                </div>
              </li>
              <li className="flex items-start gap-3 group">
                <MapPin className="shrink-0 text-fresca-bronze mt-1" size={18} />
                <span className="group-hover:text-fresca-bronze transition-colors font-sans">
                  Karlova 123<br/>
                  760 01 Zlín<br/>
                  Česká Republika
                </span>
              ...
              <li className="flex items-center gap-3 group">
                ...
                <a href="mailto:info@cantina-lafresca.cz" className="hover:text-fresca-bronze transition-colors group-hover:underline font-sans">info@cantina-lafresca.cz</a>
              </li>
            </ul>
          </div>
          ...
          <div>
           ...
           <div className="bg-stone-50 p-6 border-l-2 border-fresca-bronze shadow-sm">
              <h5 className="font-bold text-fresca-dark mb-2 font-sans">Chcete La Fresca ve vaší firmě?</h5>
              <p className="text-stone-500 text-sm mb-4 font-sans">Napište nám a my pro vás připravíme nezávaznou nabídku.</p>
