    ...
    <section id={SectionId.REFERENCES} className="py-20 bg-stone-50 text-fresca-dark border-t border-stone-100">
      <div className="container mx-auto px-4 md:px-8 text-center">
        ...
        <div className="mt-20 max-w-4xl mx-auto bg-white shadow-xl p-10 relative border-l-4 border-fresca-bronze">
          ...
          <p className="text-lg md:text-xl italic text-stone-600 mb-8 relative z-10 font-light font-sans">
          ...
          <div className="flex items-center gap-4">
              ...
              <div className="text-left">
                  <div className="text-fresca-dark font-bold uppercase tracking-widest text-sm font-sans">Jan Mičkal</div>
                  <div className="text-fresca-bronze text-xs font-sans">Jednatel společnosti</div>
              </div>
          </div>
        </div>
      </div>
